...
// UI Elements
pub const PROMPT_BORDER: Color = SANDY_BROWN;
pub const PROMPT_TEXT: Color = VANILLA;

pub const ACTIVITY_BORDER: Color = SANDY_BROWN;
pub const BANNER_BORDER: Color = SANDY_BROWN;

pub const BANNER_TEXT: Color = VANILLA;
